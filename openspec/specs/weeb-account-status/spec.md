...
1. **Placement**  
   Account status icon is shown in the **top right corner** of the screen (e.g. in header/toolbar) to the right of search box.

2. **Status icon**  
   First display status icon. Upon clicking on the icon, expand it to show a popup with  status fields. Set the status icon to "tool wheel" icon
